...
print("=== Twitter Text + Media Tweet Test ===")
...
try:
    ...
    print("\n=== Testing Media Upload and Tweet Posting ===")
    ...
    test_message = f"🧪 Test: Tweet with image from test script. Time: {now}"
